...
[![Better Auth][betterauth-shield]][betterauth-url]
...
<!-- [![OpsPilot Screenshot][product-screenshot]](https://github.com/karoldydo/opspilot) -->
...
- The homelab instance is fronted by a Cloudflare Tunnel + Access. See
  `context/deployment/deploy-plan.md` for the full narrative (single-image rationale, DSM 7.x
  specifics, rollback via pinned `sha-<short>` / digest tags).
