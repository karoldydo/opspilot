...
import { HlmSelectImports } from '../../../select/src/index';
      ...
      <nav hlmPagination>
        <ul hlmPaginationContent>
          @if (showEdges() && !_isFirstPageActive()) {
            <li (click)="goToPrevious()" hlmPaginationItem>
          ...
          @for (page of _pages(); track page) {
            <li hlmPaginationItem>
              @if (page === '...') {
                ...
                <a [isActive]="currentPage() === page" (click)="currentPage.set(page)" hlmPaginationLink>
                  {{ page }}
                </a>
              }
            </li>
          ...
          @if (showEdges() && !_isLastPageActive()) {
            <li (click)="goToNext()" hlmPaginationItem>
              <hlm-pagination-next />
            </li>
          }
        </ul>
